    ...
    <div className="min-h-screen bg-slate-50 py-12">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-slate-200 bg-white p-8 sm:p-12 shadow-sm">
          ...
          <h2 className="text-xl font-bold text-brand-blue mb-3">Lợi ích cốt lõi</h2>
          ...
          <div className="rounded-2xl bg-blue-50/70 border border-blue-200 p-6 mb-8">
            <h3 className="text-sm font-bold text-brand-blue mb-2">Đặc điểm công nghệ nền tảng</h3>
