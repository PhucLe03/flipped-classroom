      ...
      <div className="w-full max-w-md space-y-8 rounded-3xl border border-slate-200 bg-white p-8 sm:p-10 shadow-xl">
        ...
        <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className={`flex items-center justify-center rounded-xl border py-2.5 px-3 text-xs font-bold transition-all ${
                  role === 'student'
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full flex items-center justify-center gap-2 rounded-xl bg-brand-yellow py-3 text-xs font-bold text-slate-950 shadow hover:bg-brand-yellow-hover active:scale-[0.99] transition-all disabled:opacity-50 mt-2"
          >
            {loading ? (
              <>
