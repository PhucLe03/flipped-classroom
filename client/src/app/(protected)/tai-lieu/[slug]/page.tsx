        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <article className="overflow-hidden rounded-3xl border border-slate-200 bg-white p-6 sm:p-10 shadow-sm mb-8">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-4">
              {subject && (
                <span className="rounded-full bg-brand-blue px-3 py-1 text-xs font-bold text-white shadow-xs">
                  {subject.name}
                </span>
              )}
              {material.educationalLevel && material.educationalLevel !== 'Chung' && (
                <span className="rounded-full bg-amber-400 px-3 py-1 text-xs font-bold text-slate-900 shadow-xs">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 border-t border-slate-100 pt-6">
              ...
              <div className="flex items-center gap-3">
                {author?.avatar ? (
                  ...
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-brand-blue text-white font-bold text-sm">
          ...
          <div className="mt-10 rounded-2xl bg-amber-50 border border-amber-200 p-6">
            <div className="flex items-start gap-3">
              <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-amber-400 text-slate-950 shrink-0">
                <GraduationCap className="h-5 w-5" />
              </div>
              <div className="text-xs text-amber-900 leading-relaxed">
                <h4 className="font-bold mb-1">Ghi nhớ tự học tại nhà</h4>
                <p>
